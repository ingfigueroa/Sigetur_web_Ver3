...
const mdlturnodetalle = ({ show, handleClose, fila }) => {
  ...
  const handleObservacionesChange = (e) => {
    ...
    setObservaciones((prevObservaciones) => prevObservaciones ? `${prevObservaciones} - ${nuevaObservacion}` : nuevaObservacion);
  };
          ...
          <tbody>
            ...
            {Items &&
              Items.map((item) =>   {
                ...
                return(
                <tr key={item.idturno}>
                  <td style={{ textAlign: "center", fontSize: "12px" }}>{fechaFormateada}</td>
                  <td style={{ textAlign: "center", fontSize: "12px" }}>{item.estado}</td>
                  <td style={{ textAlign: "center", fontSize: "12px" }}>{item.observaciones}</td>
